          ...
          <div className="lg:col-span-8">
            {view === 'tasks' && (
              <div className="space-y-6">
                <form onSubmit={addTask} className="bg-white p-4 rounded-3xl border border-slate-200 shadow-sm space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    <div className="flex-1 w-full relative group">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-100 rounded-xl py-3 pl-12 pr-4 text-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 appearance-none"
                      />
                    </div>
                    <button 
                      type="submit"
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 rounded-3xl shadow-xl text-white overflow-hidden relative">
              ...
              <p className="text-indigo-100 text-sm leading-relaxed relative z-10">
                Assigning tasks to specific dates prevents "infinite list syndrome." Be realistic about what you can achieve in 24 hours.
              </p>
            </div>
          </div>
        </div>
